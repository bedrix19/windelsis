...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (L.GridLayer.extend({
...
/* harmony import */ var _HeatmapTileLayer_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./HeatmapTileLayer.js */ "./src/js/HeatmapTileLayer.js");
...
class MapManager {
  ...
  initializeTemperatureLayer() {
    ...
    this.temperatureLayer = new _HeatmapTileLayer_js__WEBPACK_IMPORTED_MODULE_4__["default"](this.data, {
      tileSize: 256,
      opacity: 0.65,
  ...
  updateTemperatureData() {
    ...
    this.temperatureLayer.updateData(_gridUtils_js__WEBPACK_IMPORTED_MODULE_1__["default"].tempDataBuilder(this.currentGrid));
